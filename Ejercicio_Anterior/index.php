...
echo '<a href="./index.php?Id=', urlencode($Id), '&pagina=',urlencode($pagina),'"> Ordenar por ID ' . $Id . "</a>";
echo '<a href="./index.php?Cognom=', urlencode($Cognom), '&pagina=',urlencode($pagina),'"> Ordenar por Cognom ' . $Cognom. "</a>";
echo "</div>";
...
echo '<a href="./index.php?pagina=1"> <img src="./assets/img/home.png" alt="inicio" /></a> ';
...
if (isset($_GET["Cognom"])) {
    ...
    if($pagina - 1 == 0 ){
        echo '<a href="./index.php?Cognom=', urlencode($ahoraPaginaCognom), '&pagina=',urlencode($pagina),'"><img src="./assets/img/left.png" alt="atrás"/></a>';
    } else {
        echo '<a href="./index.php?Cognom=', urlencode($ahoraPaginaCognom), '&pagina=',urlencode($pagina - 1),'"><img src="./assets/img/left.png" alt="atrás"/></a>';
    }
    
    if($pagina + 1 > $paginas){   
        echo '<a href="./index.php?Cognom=', urlencode($ahoraPaginaCognom), '&pagina=',urlencode($pagina),'"><img src="./assets/img/right.png" alt="adelante"/></a>';
    } else {
        echo '<a href="./index.php?Cognom=', urlencode($ahoraPaginaCognom), '&pagina=',urlencode($pagina + 1),'"><img src="./assets/img/right.png" alt="adelante"/></a>';
    }
    ...
    if($pagina - 1 == 0 ){
        echo '<a href="./index.php?Id=', urlencode($ahoraPaginaID), '&pagina=',urlencode($pagina),'"><img src="./assets/img/left.png" alt="atrás" /></a>';
    } else {
        echo '<a href="./index.php?Id=', urlencode($ahoraPaginaID), '&pagina=',urlencode($pagina - 1),'"><img src="./assets/img/left.png" alt="atrás"/></a>';
    }
    
    if($pagina + 1 > $paginas){   
        echo '<a href="./index.php?Id=', urlencode($ahoraPaginaID), '&pagina=',urlencode($pagina),'"><img src="./assets/img/right.png" alt="adelante"/></a>';
    } else {
        echo '<a href="./index.php?Id=', urlencode($ahoraPaginaID), '&pagina=',urlencode($pagina + 1),'"><img src="./assets/img/right.png" alt="adelante"/></a> ';
    }

} else {

    if($pagina - 1 == 0 ){
        echo '<a href="./index.php?pagina=',urlencode($pagina),'"><img src="./assets/img/left.png" alt="atrás"/></a>';
    } else {
        echo '<a href="./index.php?pagina=',urlencode($pagina - 1),'"><img src="./assets/img/left.png" alt="atrás"/></a>'; 
    }
    
    if($pagina + 1 > $paginas){   
        echo '<a href="./index.php?pagina=',urlencode($pagina),'"><img src="./assets/img/right.png" alt="adelante"/></a>';
    } else {
        echo '<a href="./index.php?pagina=',urlencode($pagina + 1),'"><img src="./assets/img/right.png" alt="adelante"/></a>';
    }

}

//Mostramos la última página
echo '<a href="./index.php?pagina='.$paginas.'"><img src="./assets/img/end.png" alt="final"/></a>';
echo "</div>";
